...
public class HelpWindow extends javax.swing.JFrame {
    ...
    public HelpWindow(java.awt.Frame parent, URL fileName) {
        ...
        try {
            ...
            if (fileName.getPath().endsWith("AboutMiTRAQ.html")) {
                setTitle("About");
                setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/icons/MiTRAQ.gif")));
            } else {
        ...
        try {
            ...
            if (fileName.getPath().endsWith("AboutMiTRAQ.html")) {
                ...
                setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().
                        getResource("/icons/box_plot_small.GIF")));
            } else {
                setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().
